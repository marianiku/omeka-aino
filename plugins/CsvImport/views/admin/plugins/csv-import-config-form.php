<fieldset id="fieldset-csv-import-rights"><legend><?php echo __('Rights and Roles'); ?></legend>
    ...
    <div class="field">
        <div class="two columns alpha">
            <?php echo $this->formLabel('csv_import_repeat_amazon_s3', __('Repeat for Amazon S3')); ?>
        </div>
        <div class="inputs five columns omega">
            <?php echo $this->formText('csv_import_repeat_amazon_s3', get_option('csv_import_repeat_amazon_s3'), null); ?>
            <p class="explanation">
                ...
                <?php echo __('Big imports succeed with "slow" = 10, "repeat" = 100 and the option "plugins.CsvImport.batchSize" = "10", but it may vary with your plan.'); ?>
            </p>
        </div>
    </div>
</fieldset>
