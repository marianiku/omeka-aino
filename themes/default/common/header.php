...
<header role="banner">
  ...
  <div id="search-container" role="search">
    <span style="width:80%;float:left;margin-right:16px;margin-top:20px;margin-bottom:0;">
      ...
      <a style="margin-left:20px;font-size:18px;" href="<?php echo html_escape(url('items/search')); ?>"><?php echo __('Laajennettu haku'); ?></a>
      <a style="margin-left:10px;font-size:18px;" href="<?php echo html_escape(url('items')); ?>"><?php echo __('Kaikki kirjeet'); ?></a>
      <a style="margin-left:10px;font-size:18px;" href="<?php echo html_escape(url('collections')); ?>"><?php echo __('Kirjeet vastaanottajan mukaan'); ?></a>
