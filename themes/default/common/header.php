    ...
    <?php fire_plugin_hook('public_body', array('view'=>$this)); ?>
        ...
        <header role="banner">
            <?php fire_plugin_hook('public_header', array('view'=>$this)); ?>
              <div id="site-title" style="width:40%;height:10%;"><?php echo link_to_home_page(theme_logo()); ?></div>
              <div id="search-container" role="search" style="margin-left:10px;width:50%;">
